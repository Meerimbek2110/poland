...
import { LiaShoppingBasketSolid } from "react-icons/lia";
import { Link } from "react-router-dom";
import { useCart } from "../../contex/CartContex"; // Подключаем твой Cart Context
...
const vipechkaData = [
  { id: 1, name: "Круассан классический", weight: "80 г", desc: "Слоёное тесто, масло сливочное", price: 150, img: vipech1 },
  { id: 2, name: "Круассан с шоколадом", weight: "100 г", desc: "Слоёное тесто, тёмный шоколад", price: 180, img: vipech2 },
  { id: 3, name: "Улитка с корицей", weight: "120 г", desc: "Сдобное тесто, корица, сахар, глазурь", price: 170, img: vipech3 },
  { id: 4, name: "Ватрушка с творогом", weight: "110 г", desc: "Дрожжевое тесто, творожная начинка", price: 140, img: vipech4 },
  { id: 5, name: "Булочка с маком", weight: "90 г", desc: "Сдобная булочка, много мака", price: 130, img: vipech5 },
  { id: 6, name: "Слойка с вишней", weight: "130 г", desc: "Слоёное тесто, вишнёвая начинка", price: 160, img: vipech6 },
];
...
function Vipech() {
  ...
  return (
    <div className="gorbluda">
      ...
      <div className="gorbluda-sort" onClick={toggleSort}>
        <span className="sort-label">СОРТИРОВАТЬ:</span>
        <span className="sort-value">{sortOrder === "asc" ? "ПО ВОЗРАСТАНИЮ ЦЕНЫ ▼" : "ПО УБЫВАНИЮ ЦЕНЫ ▲"}</span>
      </div>
