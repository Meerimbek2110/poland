...
const zakuskiData = [
  { id: 1, name: "Сырная тарелка", weight: "200 г", desc: "Пармезан, бри, дор блю, виноград, орехи, мёд", price: 850, img: snack1 },
  { id: 2, name: "Ассорти брускетт", weight: "250 г", desc: "Томаты, прошутто, песто, лосось, сливочный сыр", price: 620, img: snack2 },
  { id: 3, name: "Карпаччо из говядины", weight: "150 г", desc: "Тонкие ломтики говядины, руккола, пармезан, соус", price: 780, img: snack3 },
  { id: 4, name: "Хумус с овощами и питой", weight: "300 г", desc: "Домашний хумус, свежие овощи, тёплая пита, оливковое масло", price: 490, img: snack4 },
  { id: 5, name: "Куриные крылышки барбекю", weight: "350 г", desc: "Крылышки в соусе барбекю, подаются с соусом ранч", price: 540, img: snack5 },
  { id: 6, name: "Начос с гуакамоле", weight: "280 г", desc: "Кукурузные чипсы, соус гуакамоле, сальса, сметана", price: 470, img: snack6 },
];
      ...
      <div className="gorbluda-grid">
        {sortedZakuski.map((snack) => (
          <div key={snack.id} className="gorbluda-card">
            ...
            <div className="gorbluda-footer">
              <span className="gorbluda-price">{snack.price} ₽</span>
              <button className="gorbluda-btn" onClick={() => addToCart({ ...snack, quantity: 1 })}>
                <LiaShoppingBasketSolid className="basket-icon" />
              </button>
            </div>
          </div>
